...
export function resizeFun() {
    $(window).resize(function () {
        ...
        // scaleScene.width = windowW / 2;
        // scaleScene.height = windowH / 2;
        // upperScene.clear();
        // upperScene.beginFill(0xFF5500, 0.2)
        // upperScene.drawRect(0,0,upperScene.width,upperScene.height)
        ...
        // Rezo.sensorZoomScene.clear();
        // Rezo.sensorZoomScene.beginFill(0xFF0055, 0.2)
        // Rezo.sensorZoomScene.drawRect(0,0,windowW-10,windowH-10)
