...
class Zoom {
    static zoomScenePlus() {
        _1.Rezo.scaleScene.scale.x *= 2;
        _1.Rezo.scaleScene.scale.y *= 2;
    }
    ...
    static scrollZoom() {
        ...
        $(elem).on('mousewheel', function (event) {
            if (_1.Menu.scalBool) {
                _1.Scale.scaleBulleScroll(event);
            }
            else {
                if (event.deltaY < 0) {
    ...
    static touchZoom() {
        var sensorZoomScene2 = _1.Rezo.sensorZoomScene2;
        var sensorZoomScene = _1.Rezo.sensorZoomScene;
    ...
    static squezeZoomCalc() {
        var scaleScene = _1.Rezo.scaleScene;
        if (_1.Rezo.sensorZoomScene2.dragging && _1.Rezo.sensorZoomScene.dragging && Zoom.calculable2 && Zoom.calculable1) {
