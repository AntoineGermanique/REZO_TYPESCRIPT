...
function resizeFun(){
	$( window ).resize(function() {
		...
		upperScene.hitArea.width=windowW
		upperScene.hitArea.height=windowH
		sensorZoomScene.hitArea.width=windowW
		sensorZoomScene.hitArea.height=windowH
		sensorZoomScene2.hitArea.width=windowW
		sensorZoomScene2.hitArea.height=windowH
